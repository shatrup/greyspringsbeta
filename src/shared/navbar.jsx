...
class NavBar extends React.Component
{
    ...
    {
        return(
            <div className="ksx-navbar themedark">
                <header id="home">
                    <nav id="nav-wrap">
                        ...
                        <ul id="nav" className="nav">
                            ...
                            <li><a className="smoothscroll" href="#styles">Style Guide</a></li>
                        </ul>
                    </nav>
                ...
                <a className="smoothscroll" href="#styles"><i className="icon-down-circle"></i></a>
                </p>
                </header>
            </div>
        );
